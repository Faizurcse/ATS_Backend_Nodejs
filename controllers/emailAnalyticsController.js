...
export const getEmailAnalytics = async (req, res) => {
  try {
    ...
    const jobEmailAnalytics = await getJobEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear);

    // 2. CANDIDATE EMAIL ANALYTICS
    const candidateEmailAnalytics = await getCandidateEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear);

    // 3. CUSTOMER EMAIL ANALYTICS
    const customerEmailAnalytics = await getCustomerEmailAnalytics();

    // 4. INTERVIEW EMAIL ANALYTICS
    const interviewEmailAnalytics = await getInterviewEmailAnalytics(now, startOfMonth, endOfMonth);

    // 5. TIMESHEET EMAIL ANALYTICS
    const timesheetEmailAnalytics = await getTimesheetEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear);

    // 6. EMAIL TRENDS AND INSIGHTS
    const emailTrendsAndInsights = await getEmailTrendsAndInsights(now, startOfMonth, endOfMonth);
...
async function getJobEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear) {
  try {
...
async function getCandidateEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear) {
  try {
...
async function getCustomerEmailAnalytics() {
  try {
...
async function getInterviewEmailAnalytics(now, startOfMonth, endOfMonth) {
  try {
...
async function getTimesheetEmailAnalytics(now, startOfMonth, endOfMonth, startOfYear, endOfYear) {
  try {
...
async function getEmailTrendsAndInsights(now, startOfMonth, endOfMonth) {
  try {
